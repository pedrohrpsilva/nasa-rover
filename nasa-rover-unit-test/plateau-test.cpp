...
TEST(OutsidePlateau, Outside) {
    ...
    for (int i = 0; i < kNumSamples; ++i) {
        ...
        EXPECT_TRUE(OutsidePlateau(plateua, Coordinate(upper_right_coordinate.x, upper_right_coordinate.y + delta)));
        EXPECT_TRUE(OutsidePlateau(plateua, Coordinate(upper_right_coordinate.x + delta, upper_right_coordinate.y)));
        EXPECT_TRUE(OutsidePlateau(plateua, Coordinate(upper_right_coordinate.x + delta, upper_right_coordinate.y + delta)));
    }
